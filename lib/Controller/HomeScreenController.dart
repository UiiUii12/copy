...
class HomeScreenController extends GetxController {
  ...
  void onInit() async{
    SharedPreferences prefs_address = await SharedPreferences.getInstance();
    address.value = prefs_address.getString("address")!;
    SharedPreferences prefs_nom = await SharedPreferences.getInstance();
    nom.value = prefs_nom.getString("nom")!;

...
class Food extends StatelessWidget {
  ...
  String resId ;
  String categore ;
  Food( {Key? key,  required this.image,  required this.name,
    required this.prix , required this.ajouter , this.nom_restaurant ,
    required this.description,this.List_of_food, required this.id,
    required this.resId, required this.categore,  }) : super(key: key) ;
